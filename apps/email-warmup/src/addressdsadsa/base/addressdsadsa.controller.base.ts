...
export class AddressdsadsaControllerBase {
  constructor(
  ...
  @common.Post()
  @swagger.ApiCreatedResponse({ type: Addressdsadsa })
  ...
  async create(
    @common.Body() data: AddressdsadsaCreateInput
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [Addressdsadsa] })
  @ApiNestedQuery(AddressdsadsaFindManyArgs)
  @nestAccessControl.UseRoles({
    resource: "Addressdsadsa",
    action: "read",
    possession: "any",
  ...
  async findMany(@common.Req() request: Request): Promise<Addressdsadsa[]> {
    const args = plainToClass(AddressdsadsaFindManyArgs, request.query);
  ...
  async findOne(
    @common.Param() params: AddressdsadsaWhereUniqueInput
  ...
  async update(
    @common.Param() params: AddressdsadsaWhereUniqueInput,
    @common.Body() data: AddressdsadsaUpdateInput
  ): Promise<Addressdsadsa | null> {
    try {
