...
import { ADDRESSDSADSA_TITLE_FIELD } from "./AddressdsadsaTitle";

export const AddressdsadsaShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
        ...
        <TextField label="tets" source="tets" />
